...
@Injectable({
  // @ decorator
  providedIn: 'root', // Faz com que essa classe de serviços seja carregados na raiz
})

// Numa classe de serviços, só utilize variáveis estáticas que não é alterado.
// Usar apenas métodos simples que não seja alterado
// O Angular irá compartilhar essa classe com todas as referências
export class CourseService {
  ...
  save(course: Course): Observable<Course> {
    if (course.id) {
      ...
      return this.httpClient.put<Course>( // put é pra atualizar
